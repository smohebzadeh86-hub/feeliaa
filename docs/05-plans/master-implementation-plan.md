...
| **P3-1** | تصمیم درباره‌ی بازنشستگیِ `SonioxDirect`، `/ws/t`، `/ws/voice`، `POST voice-note`، ~~`/api/stt/check` proxy probe~~ (انجام شد 2026-09-24) | LAW-015؛ کاهشِ سطحِ کد | P1-4 | تصمیمِ مالک؛ داده‌ی استفاده | مرورگرهای قدیمی بدونِ مسیر | — | subsystem 04 |
